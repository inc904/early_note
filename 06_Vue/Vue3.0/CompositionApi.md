# [#](https://24kcs.github.io/vue3_study/chapter4/01_Composition API_常用部分.html#_1-composition-api-常用部分)1. Composition API(常用部分)
...
export default {
  ...
  setup () {
    ...
    // 定义响应式数据 ref对象
    const count = ref(1)
# 在模板中仍然可以使用一个 没有使用 ref 定义的 变量，但是没有响应式结果，修改值不会 及时更新在模板中，但是数据中的 值 确实被修改了
    const gender = 1 
    console.log(count)
...
# [#](https://24kcs.github.io/vue3_study/chapter4/02_Composition API_其它部分.html#_2-composition-api-其它部分)2. Composition API(其它部分)
...
# [#](https://24kcs.github.io/vue3_study/chapter4/03_手写组合API.html#_3-手写组合api)3. 手写组合API
...
# [#](https://24kcs.github.io/vue3_study/chapter4/04_Composition VS Option.html#_4-composition-api-vs-option-api)4. Composition API VS Option API
...
# [#](https://24kcs.github.io/vue3_study/chapter5/01_新组件.html#_1-新组件)1. 新组件
...
# [#](https://24kcs.github.io/vue3_study/chapter5/02_其他新API.html#_2-其他新的api)2. 其他新的API
